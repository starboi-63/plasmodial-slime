...
>If you're interested in the math used to model the simulation's slime foraging behavior, I made a writeup on my [website](https://tanishmakadia.com/projects/slime-simulation).
